...
@Component("socureJsonProfileProvider")
public class SocureJsonProfileProvider implements ProfileProvider{
	...
	public void loader() throws IOException {
		Resource[] resources = new PathMatchingResourcePatternResolver().getResources("/socure/*.json");
	...
	public Object getProperty(String serviceName, String key, String tenantId) throws BaseException {
		...
		if (serviceObj == null) {
			throw new BaseException(HttpStatus.BAD_REQUEST,
					"Service not found in JSON file for serviceName: " + serviceName);
		}
